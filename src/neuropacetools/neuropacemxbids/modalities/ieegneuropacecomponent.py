...
# Definitions #
# Classes #
class IEEGNEUROPACEComponent(IEEGCDFSComponent):
    """A UCSF BIDS Component which contains a NEUROPACECDFS as part of its structure.
    ...
    """
    cdfs_type: type[NEUROPACECDFS] = NEUROPACECDFS


# Registration #
IEEG.component_types_register.register_class(IEEGNEUROPACEComponent)
