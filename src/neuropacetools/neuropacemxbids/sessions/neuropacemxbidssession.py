"""neuropacemxbidssession.py
A MXBIDS Session which contains a NEUROPACECDFS as part of its structure.
"""
# Package Header #
from ...header import *
...
from mxbids.modalities import Modality, CT
from mxbids.cdfsbids import CDFSSession

# Local Packages #
from ..modalities import IEEGNEUROPACE


# Definitions #
# Classes #
class NEUROPACEMXBIDSSession(CDFSSession):
    """A UCSF BIDS Session which contains a NEUROPACECDFS as part of its structure.
